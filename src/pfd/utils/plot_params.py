...
class PlotParams:
    ...
    def __init__(self, cfg: dict) -> None:
        ...
        self.xtick_labelsize, self.ytick_labelsize = (
            self.medium * PlotParams.font_scalings["small"],
            self.medium * PlotParams.font_scalings["small"],
        )
    ...
    def set_rc_params(self, kind: str, fig_size: tuple) -> dict:
        ...
        """
        if kind == "fig_small":  # 50%, single plots (6.4, 4.8)
            factor = 1.0
        elif kind == "fig_medium":  # 75%, 2x2 plots (6.4, 4.8)
            factor = 0.5 / 0.75
        elif (
            kind == "fig_big"
