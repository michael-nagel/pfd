...
Relative accuracy (Table~4)    & $|e_0| - |e_T|$            & 82.6  & cluster-robust, two-way \\
...
We therefore use the referee's own fallback, cluster-robust
...
errors rise by a factor of \textbf{3.0} in the unbiasedness regression (6.3
