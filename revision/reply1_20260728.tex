...
\begin{table}[h]
\centering
\caption{The coefficient path $\beta_1$ at alternative filter thresholds. Estimated on the continuous specification, which additionally discards updates recorded after kickoff.}
\label{tab:r1c5b}
\small
