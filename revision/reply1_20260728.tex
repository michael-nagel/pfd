...
\ReplyMN{All prices are now margin-adjusted (Comment~1), and the censoring does not reach the learning-rate estimate, whose support points lie in the closing half of the window and never touch the stretch that a truncated series leaves unobserved (Comment~5).
